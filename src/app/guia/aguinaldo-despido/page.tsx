  ...
  return (
    <article className="space-y-6 text-[15px] leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">La liquidación final tiene más conceptos que la sola indemnización. <Link href="/indemnizacion/" className="underline hover:text-emerald-600">Calculá tu liquidación completa</Link>.</p>
      </header>
