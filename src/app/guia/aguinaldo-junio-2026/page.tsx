  ...
  return (
    <article className="space-y-6 text-[15px] leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-base text-neutral-600 dark:text-neutral-400">El SAC del primer semestre se paga hasta el 30 de junio. Todos los montos están calculados con nuestra <Link href="/aguinaldo/" className="underline hover:text-emerald-700">calculadora de aguinaldo</Link>.</p>
      </header>
