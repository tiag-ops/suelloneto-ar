  ...
  return (
    <article className="space-y-6 text-[15px] leading-relaxed">
      <header className="space-y-2">
        ...
        <p className="text-base text-neutral-600 dark:text-neutral-400">Art. 201 LCT. Con la <Link href="/horas-extras/" className="underline hover:text-emerald-700">calculadora de horas extras</Link>.</p>
      </header>
