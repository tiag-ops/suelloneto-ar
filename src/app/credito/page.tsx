  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">La cuota fija del sistema francés es constante todo el préstamo: al principio pagás más intereses y al final más capital. No incluye seguros ni gastos administrativos.</p>
      </header>
      <Pagina />
    </div>
  );
