  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Conocé el número de CUIL que te corresponde según tu DNI. Es el cálculo matemático oficial: el número real se asigna cuando te inscribes en ARCA/Anses.</p>
      </header>
      <Pagina />
    </div>
  );
