  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">El dólar tarjeta aplica sobre el oficial las percepciones a compras en el exterior (Bienes Personales + Impuesto a los Gastos). Configurá los porcentajes vigentes del día.</p>
      </header>
      <Pagina />
    </div>
  );
